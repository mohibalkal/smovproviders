import { Embed, Sourcerer, makeSourcerer } from '@/providers/base';
...
export function gatherAllSources(): Array<Sourcerer> {
  ...
  return [
    makeSourcerer(embedSuScraper),
    makeSourcerer(vidsrcsuScraper),
    makeSourcerer(slideMoviesScraper),
    makeSourcerer(catflixScraper),
    makeSourcerer(flixhqScraper),
    makeSourcerer(remotestreamScraper),
    makeSourcerer(kissAsianScraper),
    makeSourcerer(showboxScraper),
    makeSourcerer(goMoviesScraper),
    makeSourcerer(zoechipScraper),
    makeSourcerer(vidsrcScraper),
    makeSourcerer(lookmovieScraper),
    makeSourcerer(nsbxScraper),
    makeSourcerer(smashyStreamScraper),
    makeSourcerer(ridooMoviesScraper),
    makeSourcerer(vidSrcToScraper),
    makeSourcerer(nepuScraper),
    makeSourcerer(goojaraScraper),
    makeSourcerer(hdRezkaScraper),
    makeSourcerer(m4uScraper),
    makeSourcerer(primewireScraper),
    makeSourcerer(warezcdnScraper),
    makeSourcerer(insertunitScraper),
    makeSourcerer(nitesScraper),
    makeSourcerer(soaperTvScraper),
    makeSourcerer(autoembedScraper),
    makeSourcerer(tugaflixScraper),
    makeSourcerer(ee3Scraper),
    makeSourcerer(whvxScraper),
  ];
}
